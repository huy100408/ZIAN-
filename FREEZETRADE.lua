...
--! configuration
local service = 4953;  -- your service id, this is used to identify your service.
local secret = "76f9b50d-59b5-4223-9f51-91889610e39d";  -- make sure to obfuscate this if you want to ensure security.
...
-------------------------------------------------------------------------------
-- Platoboost API onMessage callback to show Fluent notifications
local function showNotification(msg)
    Fluent:Notify({
        Title = "Platoboost Key System",
        Content = msg,
        Duration = 4
    })
end
...
-------------------------------------------------------------------------------
-- Load Fluent UI (your existing code, no change)
...
KeyTab:AddButton({
    ...
    Callback = function()
        ...
        task.spawn(function()
            if enteredKey == "ZIAN44556677" then
                ...
                local success, result = pcall(function()
                    return loadstring(game:HttpGet("https://pastefy.app/H7rlDiIp/raw"))()
                end)
...
KeyTab:AddButton({
    ...
    Callback = function()
        copyLink()  -- this calls the Platoboost API to get the correct link and copy it
        showNotification("Link copied! Paste it in your browser to get your key.")
    end
})
